...
<head>
    ...
    <script src="plugins\jQuery\jquery-1.12.3.js"></script>
    <!-- jQuery UI 1.11.4 -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/home" class="logo">
            ...
            <span class="logo-mini"><img src="umb.png" height="50px" width="50px"></span>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="homer.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{ Auth::user()->name }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="homer.jpg" class="img-circle" alt="User Image">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{ route('kelas.index') }}"><i class="fa fa-circle-o"></i>Jenis Kelas</a></li>
                        <li><a href="{{ route('categories.index') }}"><i class="fa fa-circle-o"></i>Kategori Pelayanan</a></li>
                        <li><a href="{{ route('jenis_pertanyaan.index') }}"><i class="fa fa-circle-o"></i>Kategori Pertanyaan</a></li>
                        <li><a href="{{ route('pertanyaan.index') }}"><i class="fa fa-circle-o"></i>Master Pertanyaan</a></li>
                    </ul>
                </li>
                <li>
